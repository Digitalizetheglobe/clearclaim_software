...
router.post('/populate', requireRole(['admin']), async (req, res) => {
  try {
    const caseFieldsData = [
      ...
      { field_key: 'Name as per Certificate H3', field_label: 'Name as per Certificate H3', field_type: 'text', field_category: 'deceased_info', display_order: 41 },
      { field_key: 'Name as per DC H3', field_label: 'Name as per DC H3', field_type: 'text', field_category: 'deceased_info', display_order: 42 },
      { field_key: 'DOD H3', field_label: 'DOD H3', field_type: 'date', field_category: 'deceased_info', display_order: 43 },
      { field_key: 'Deceased Place H3', field_label: 'Deceased Place H3', field_type: 'text', field_category: 'deceased_info', display_order: 44 },
      { field_key: 'Claimant Relation H3', field_label: 'Claimant Relation H3', field_type: 'text', field_category: 'deceased_info', display_order: 45 },
      { field_key: 'Name as per Certificate H4', field_label: 'Name as per Certificate H4', field_type: 'text', field_category: 'deceased_info', display_order: 46 },
      { field_key: 'Name as per DC H4', field_label: 'Name as per DC H4', field_type: 'text', field_category: 'deceased_info', display_order: 47 },
      { field_key: 'DOD H4', field_label: 'DOD H4', field_type: 'date', field_category: 'deceased_info', display_order: 48 },
      { field_key: 'Deceased Place H4', field_label: 'Deceased Place H4', field_type: 'text', field_category: 'deceased_info', display_order: 49 },
      { field_key: 'Claimant Relation H4', field_label: 'Claimant Relation H4', field_type: 'text', field_category: 'deceased_info', display_order: 50 },
