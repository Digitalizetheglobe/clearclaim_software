...
router.post('/populate', requireRole(['admin']), async (req, res) => {
  try {
    const caseFieldsData = [
      ...
      { field_key: 'Name as per Aadhar LH1', field_label: 'Name as per Aadhar LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 87 },
      { field_key: 'Name as per PAN LH1', field_label: 'Name as per PAN LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 88 },
      { field_key: 'Name as per Succession/Will LH1', field_label: 'Name as per Succession/Will LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 89 },
      { field_key: 'Father Name LH1', field_label: 'Father Name LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 90 },
      { field_key: 'Address LH1', field_label: 'Address LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 91 },
      { field_key: 'Mobile No LH1', field_label: 'Mobile No LH1', field_type: 'phone', field_category: 'legal_heir_info', display_order: 92 },
      { field_key: 'Relation LH1', field_label: 'Relation LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 93 },
      { field_key: 'Age LH1', field_label: 'Age LH1', field_type: 'number', field_category: 'legal_heir_info', display_order: 94 },
      
      { field_key: 'Name as per Aadhar LH2', field_label: 'Name as per Aadhar LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 95 },
      { field_key: 'Name as per PAN LH2', field_label: 'Name as per PAN LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 96 },
      { field_key: 'Name as per Succession/Will LH2', field_label: 'Name as per Succession/Will LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 97 },
      { field_key: 'Father Name LH2', field_label: 'Father Name LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 98 },
      { field_key: 'Address LH2', field_label: 'Address LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 99 },
      { field_key: 'Mobile No LH2', field_label: 'Mobile No LH2', field_type: 'phone', field_category: 'legal_heir_info', display_order: 100 },
      { field_key: 'Relation LH2', field_label: 'Relation LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 101 },
      { field_key: 'Age LH2', field_label: 'Age LH2', field_type: 'number', field_category: 'legal_heir_info', display_order: 102 },
      
      { field_key: 'Name as per Aadhar LH3', field_label: 'Name as per Aadhar LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 103 },
      { field_key: 'Name as per PAN LH3', field_label: 'Name as per PAN LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 104 },
      { field_key: 'Name as per Succession/Will LH3', field_label: 'Name as per Succession/Will LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 105 },
      { field_key: 'Father Name LH3', field_label: 'Father Name LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 106 },
      { field_key: 'Address LH3', field_label: 'Address LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 107 },
      { field_key: 'Mobile No LH3', field_label: 'Mobile No LH3', field_type: 'phone', field_category: 'legal_heir_info', display_order: 108 },
      { field_key: 'Relation LH3', field_label: 'Relation LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 109 },
      { field_key: 'Age LH3', field_label: 'Age LH3', field_type: 'number', field_category: 'legal_heir_info', display_order: 110 },
      
      { field_key: 'Name as per Aadhar LH4', field_label: 'Name as per Aadhar LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 111 },
      { field_key: 'Name as per PAN LH4', field_label: 'Name as per PAN LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 112 },
      { field_key: 'Name as per Succession/Will LH4', field_label: 'Name as per Succession/Will LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 113 },
      { field_key: 'Father Name LH4', field_label: 'Father Name LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 114 },
      { field_key: 'Address LH4', field_label: 'Address LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 115 },
      { field_key: 'Mobile No LH4', field_label: 'Mobile No LH4', field_type: 'phone', field_category: 'legal_heir_info', display_order: 116 },
      { field_key: 'Relation LH4', field_label: 'Relation LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 117 },
      { field_key: 'Age LH4', field_label: 'Age LH4', field_type: 'number', field_category: 'legal_heir_info', display_order: 118 },
      
      { field_key: 'Name as per Aadhar LH5', field_label: 'Name as per Aadhar LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 119 },
      { field_key: 'Name as per PAN LH5', field_label: 'Name as per PAN LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 120 },
      { field_key: 'Name as per Succession/Will LH5', field_label: 'Name as per Succession/Will LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 121 },
      { field_key: 'Father Name LH5', field_label: 'Father Name LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 122 },
      { field_key: 'Address LH5', field_label: 'Address LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 123 },
      { field_key: 'Mobile No LH5', field_label: 'Mobile No LH5', field_type: 'phone', field_category: 'legal_heir_info', display_order: 124 },
      { field_key: 'Relation LH5', field_label: 'Relation LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 125 },
      { field_key: 'Age LH5', field_label: 'Age LH5', field_type: 'number', field_category: 'legal_heir_info', display_order: 126 },
      
      // Additional Information
      { field_key: 'Date of Issue', field_label: 'Date of Issue', field_type: 'date', field_category: 'additional_info', display_order: 127 }
    ];
