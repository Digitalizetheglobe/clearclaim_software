...
const caseFieldsData = [
  ...
  // Share Certificate Information (SC1-SC5)
  ...
  { field_key: 'Name as per Aadhar LH1', field_label: 'Name as per Aadhar LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 143 },
  { field_key: 'Name as per PAN LH1', field_label: 'Name as per PAN LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 144 },
  { field_key: 'Name as per Succession/Will LH1', field_label: 'Name as per Succession/Will LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 145 },
  { field_key: 'Father Name LH1', field_label: 'Father Name LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 146 },
  { field_key: 'Address LH1', field_label: 'Address LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 147 },
  { field_key: 'Mobile No LH1', field_label: 'Mobile No LH1', field_type: 'phone', field_category: 'legal_heir_info', display_order: 148 },
  { field_key: 'Relation LH1', field_label: 'Relation LH1', field_type: 'text', field_category: 'legal_heir_info', display_order: 149 },
  { field_key: 'Age LH1', field_label: 'Age LH1', field_type: 'number', field_category: 'legal_heir_info', display_order: 150 },

  { field_key: 'Name as per Aadhar LH2', field_label: 'Name as per Aadhar LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 151 },
  { field_key: 'Name as per PAN LH2', field_label: 'Name as per PAN LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 152 },
  { field_key: 'Name as per Succession/Will LH2', field_label: 'Name as per Succession/Will LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 153 },
  { field_key: 'Father Name LH2', field_label: 'Father Name LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 154 },
  { field_key: 'Address LH2', field_label: 'Address LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 155 },
  { field_key: 'Mobile No LH2', field_label: 'Mobile No LH2', field_type: 'phone', field_category: 'legal_heir_info', display_order: 156 },
  { field_key: 'Relation LH2', field_label: 'Relation LH2', field_type: 'text', field_category: 'legal_heir_info', display_order: 157 },
  { field_key: 'Age LH2', field_label: 'Age LH2', field_type: 'number', field_category: 'legal_heir_info', display_order: 158 },

  { field_key: 'Name as per Aadhar LH3', field_label: 'Name as per Aadhar LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 159 },
  { field_key: 'Name as per PAN LH3', field_label: 'Name as per PAN LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 160 },
  { field_key: 'Name as per Succession/Will LH3', field_label: 'Name as per Succession/Will LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 161 },
  { field_key: 'Father Name LH3', field_label: 'Father Name LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 162 },
  { field_key: 'Address LH3', field_label: 'Address LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 163 },
  { field_key: 'Mobile No LH3', field_label: 'Mobile No LH3', field_type: 'phone', field_category: 'legal_heir_info', display_order: 164 },
  { field_key: 'Relation LH3', field_label: 'Relation LH3', field_type: 'text', field_category: 'legal_heir_info', display_order: 165 },
  { field_key: 'Age LH3', field_label: 'Age LH3', field_type: 'number', field_category: 'legal_heir_info', display_order: 166 },

  { field_key: 'Name as per Aadhar LH4', field_label: 'Name as per Aadhar LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 167 },
  { field_key: 'Name as per PAN LH4', field_label: 'Name as per PAN LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 168 },
  { field_key: 'Name as per Succession/Will LH4', field_label: 'Name as per Succession/Will LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 169 },
  { field_key: 'Father Name LH4', field_label: 'Father Name LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 170 },
  { field_key: 'Address LH4', field_label: 'Address LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 171 },
  { field_key: 'Mobile No LH4', field_label: 'Mobile No LH4', field_type: 'phone', field_category: 'legal_heir_info', display_order: 172 },
  { field_key: 'Relation LH4', field_label: 'Relation LH4', field_type: 'text', field_category: 'legal_heir_info', display_order: 173 },
  { field_key: 'Age LH4', field_label: 'Age LH4', field_type: 'number', field_category: 'legal_heir_info', display_order: 174 },

  { field_key: 'Name as per Aadhar LH5', field_label: 'Name as per Aadhar LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 175 },
  { field_key: 'Name as per PAN LH5', field_label: 'Name as per PAN LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 176 },
  { field_key: 'Name as per Succession/Will LH5', field_label: 'Name as per Succession/Will LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 177 },
  { field_key: 'Father Name LH5', field_label: 'Father Name LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 178 },
  { field_key: 'Address LH5', field_label: 'Address LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 179 },
  { field_key: 'Mobile No LH5', field_label: 'Mobile No LH5', field_type: 'phone', field_category: 'legal_heir_info', display_order: 180 },
  { field_key: 'Relation LH5', field_label: 'Relation LH5', field_type: 'text', field_category: 'legal_heir_info', display_order: 181 },
  { field_key: 'Age LH5', field_label: 'Age LH5', field_type: 'number', field_category: 'legal_heir_info', display_order: 182 },

  // Additional Information
  { field_key: 'Date of Issue', field_label: 'Date of Issue', field_type: 'date', field_category: 'additional_info', display_order: 183 }
];
